...
export class AppService
  ...
  onApplicationBootstrap(): any {
    Logger.log('Bootstrap initialized...', 'onApplicationBootstrap', true);
  }

  onModuleInit(): any {
    Logger.log('Module initialized...', 'onModuleInit', true);
  }

  onApplicationShutdown(signal?: string): any {
    Logger.log(
      'Application shutdown by signal: '.concat(signal),
